...
class FloatingLabel: UITextField {
    ...
    @IBInspectable
    var floatingLabelColor: UIColor = UIColor.orange {
        didSet {
    ...
    @objc func addFloatingLabel() {
        if self.text == "" {
            ...
            self.floatingLabel.bottomAnchor.constraint(equalTo: self.topAnchor, constant: 8).isActive = true // Place our label 10 pts above the text field
            self.placeholder = ""
        }
